...
for (d_set in M_M4[indices.m4]) {
  ...
  # manage dates with different frequencies
  if (freq == 'quarter') {
...
for (d_set in M_M4[indices.m4]) {
  ...
  perfMetrics <- calculateMetrics(new_data, 'ets_xls', d_set$st, multi_metric)
  ...
  perfMetrics <- calculateMetrics(new_data, 'prophet', d_set$st, multi_metric)
  final_results_df <- bind_rows(final_results_df, perfMetrics)
